<template lang="html">
  <div :val="value_">
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="1" size="mini" border>每月</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="5" size="mini" border>不指定</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="2" size="mini" border>周期</el-radio></el-col>
      <el-col :span="20">
    ...
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="3" size="mini" border>循环</el-radio></el-col>
      <el-col :span="20">
        <span style="margin-left: 10px; margin-right: 5px;">从</span>
    ...
    <el-checkbox-group v-model="appoint">
      <el-row :gutter="10">
        <el-col :span="2" v-for="i in 12" :key="i">
