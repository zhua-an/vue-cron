...
<template lang="html">
  <div :val="value_">
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="1" size="mini" border>每{{lable}}</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
    ...
    <el-checkbox-group v-model="appoint">
      <el-row :gutter="10" v-for="i in 6" :key="i">
        <el-col :span="2" v-for="j in 10" :key="j">
          <el-checkbox @change="type = '4'" :label="(i - 1) + '' + (j - 1)"></el-checkbox>
        </el-col>
      </el-row>
    </el-checkbox-group>
  </div>
