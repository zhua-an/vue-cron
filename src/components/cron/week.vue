<template lang="html">
  <div :val="value_">
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="1" size="mini" border>每周</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
    ...
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="7" size="mini" border>指定周</el-radio></el-col>
      <el-col :span="19">
    ...
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="6" size="mini" border>本月最后一个</el-radio></el-col>
      <el-col :span="19">
    ...
    <el-row :gutter="20">
      <el-col :span="4"><el-radio v-model="type" label="4" size="mini" border>指定</el-radio></el-col>
    </el-row>
    <el-checkbox-group v-model="appoint">
      <el-row :gutter="10">
        <el-col :span="2" v-for="i in 7" :key="i">
          <el-checkbox @change="type = '4'" :label="i + ''"></el-checkbox>
        </el-col>
      </el-row>
    </el-checkbox-group>
  </div>
