<template lang="html">
  <div :val="value_">
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="1" size="mini" border>每日</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="5" size="mini" border>不指定</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="2" size="mini" border>周期</el-radio></el-col>
      <el-col :span="19">
    ...
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="3" size="mini" border>循环</el-radio></el-col>
      <el-col :span="19">
        <span style="margin-left: 10px; margin-right: 5px;">从</span>
    ...
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="8" size="mini" border>工作日</el-radio></el-col>
      <el-col :span="19">
    ...
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="6" size="mini" border>本月最后一天</el-radio></el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="5"><el-radio v-model="type" label="4" size="mini" border>指定</el-radio></el-col>
    </el-row>
    <el-checkbox-group v-model="appoint">
      <el-row :gutter="10" v-for="i in 4" :key="i">
        <el-col :span="2" v-for="j in 10" :key="j">
          <el-checkbox @change="type = '4'"  v-if="parseInt((i - 1) + '' + (j - 1)) < 32 && !(i === 1 && j === 1)" :label="(i - 1) + '' + (j - 1)"></el-checkbox>
        </el-col>
      </el-row>
    </el-checkbox-group>
  </div>
